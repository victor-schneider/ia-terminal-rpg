  ...
  public static Context main() {
    ...
    ChatLanguageModel model = VertexAiGeminiChatModel.builder()
      ...
      PromptTemplate promptTemplate = PromptTemplate.from(
        ...
        "Quando o jogador selecionar uma opção que irá levar à um inimigo, você irá retornar no JSON o campo 'combate' como TRUE, senão FALSE. Se retornado como TRUE, as opções terão a ver com atacar o inimigo, fugir ou uma opção adicional que você irá criar."+
